...
from operations.views import AdditionView,MultiplicationView,SubtractionView,FactorialView,PrimeNumberView,BmiView,SignUpView,BmrView,TempConversionView,BmiVersiontwoView,BmrVersiontwoView 

urlpatterns = [
    path('admin/', admin.site.urls),
    path('add/',AdditionView.as_view()),
    path('mul/',MultiplicationView.as_view()),
    ...
    path('bmi/v2/',BmiVersiontwoView.as_view()),
